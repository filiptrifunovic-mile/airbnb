      ...
      {action === "new" && (
        <div>
          <form>
            ...
            <p className="text-gray-500 text-sm">Place to upload photos.</p>
            <div className="flex gap-2">
              <input type="text" placeholder="add using a link from web" />
              <button className="bg-gray-200 px-4 rounded-2xl">
                Add photo
              </button>
            </div>
            <div className="mt-2 grid grid-cols-3 lg:grid-cols-6 md:grid-cols-4">
              <button className="mt-10 flex gap-1 justify-center border-2 bg-transparent rounded-2xl p-8 text-2xl text-gray-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
